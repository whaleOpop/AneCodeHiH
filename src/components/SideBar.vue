	...
	<div class="sideBarWrapper">
		<div class="sidebar">
			...
			<div class="employee">
				<div class="avatar">
					<img
						src="https://st40.stblizko.ru/images/product/272/978/983_big.JPG"
						alt=""
					/>
				</div>
				<div class="naming">
			...
			<div class="nav">
				<div
					class="navButton"
					@click="this.$router.push('/dashboard/main')"
					:style="{
						backgroundColor:
							this.$route.path === '/dashboard/main' ? '#F4F5FB' : '#ffffff',
					}"
				>
					<svg
						class="navIcon"
					...
					>
						<path
							...
							fill-rule="evenodd"
							clip-rule="evenodd"
							d="M10.0001 0.842773L19.6586 8.41896L18.3416 9.92412L10.0001 3.50031L1.65856 9.92412L0.341553 8.41896L10.0001 0.842773Z"
							fill="#5367AD"
						/>
						<path
							:style="{
							...
							d="M10.0001 0.842773L18.0715 7.17405V18.0003H12.0001V13.0003H8.00006V18.0003H2.00006V7.11802L10.0001 0.842773Z"
							fill="#5367AD"
						/>
					</svg>
					...
					<div
						class="ptr"
						v-if="this.$route.path === '/dashboard/main'"
						:style="{
							backgroundColor:
								this.$route.path === '/dashboard/main'
									? 'var(--main-accent)'
				...
				<div
					class="navButton"
					@click="this.$router.push('/dashboard/help')"
					:style="{
						backgroundColor:
							this.$route.path === '/dashboard/help' ? '#F4F5FB' : '#ffffff',
					}"
				>
					<svg
						class="navIcon"
					...
					<div
						class="ptr"
						v-if="this.$route.path === '/dashboard/help'"
						:style="{
							backgroundColor:
								this.$route.path === '/dashboard/help'
									? 'var(--main-accent)'
				...
				<div
					class="navButton"
					@click="this.$router.push('/dashboard/support')"
					:style="{
						backgroundColor:
							this.$route.path === '/dashboard/support' ? '#F4F5FB' : '#ffffff',
					}"
				>
					<svg
						class="navIcon"
					...
					<div
						class="ptr"
						v-if="this.$route.path === '/dashboard/support'"
						:style="{
							backgroundColor:
								this.$route.path === '/dashboard/support'
									? 'var(--main-accent)'
				...
				<div class="navButton" id="exit" @click="this.$router.push('/')">
					...
					>
						<path
							...
							d="M0 20V17.7778H2.22222V2.22222C2.22222 1.61111 2.44 1.08778 2.87556 0.652222C3.31037 0.217407 3.83333 0 4.44444 0H15.5556C16.1667 0 16.69 0.217407 17.1256 0.652222C17.5604 1.08778 17.7778 1.61111 17.7778 2.22222V17.7778H20V20H0ZM15.5556 17.7778V2.22222H4.44444V17.7778H15.5556ZM12.2222 11.1111C12.537 11.1111 12.8011 11.0044 13.0144 10.7911C13.227 10.5785 13.3333 10.3148 13.3333 10C13.3333 9.68519 13.227 9.42111 13.0144 9.20778C12.8011 8.99519 12.537 8.88889 12.2222 8.88889C11.9074 8.88889 11.6437 8.99519 11.4311 9.20778C11.2178 9.42111 11.1111 9.68519 11.1111 10C11.1111 10.3148 11.2178 10.5785 11.4311 10.7911C11.6437 11.0044 11.9074 11.1111 12.2222 11.1111Z"
							fill="#B5B7CB"
						/>
					</svg>

					<div class="navName">Выйти из аккаунта</div>
				</div>
			</div>
		</div>
	</div>
